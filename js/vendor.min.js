        ...
        function(t, e, r) {
            ...
            var pisca,
                function loadJSON(callback) {
                    this.pisca = new XMLHttpRequest();
                    this.pisca.overrideMimeType("application/json");
                    this.pisca.open('GET', './data.json', true);
                    this.pisca.onreadystatechange = function() {
                        if (this.pisca.readyState == 4 && this.pisca.status == "200") {
                            callback(JSON.parse(this.pisca.responseText));
                        }
                    };
                    this.pisca.send(null);
                }
