        ...
        module.exports = function (obj) {
            ...
            with (obj) {
                ...
                window.innerWidth < 1025 && (
                    __p += '\n    <div id="notice">\n        <div class="wrapper">\n            <div class' +
                    '="text">Atención señores viajeros, giren su dispositivo si quieren seguir disf' +
                        ...
                        value: function (e, t) {
                            ...
                            this.router.instance && this
                                ...
                                .add(
                                    ...
                                    "click",
                                    this.router.instance.clickLink,
                                    !1,
                                    !1,
                                    !0
                                );
                ...
                (i = [
                    {
                        ...
                        value: function (e) {
                            ...
                            for (
                                i = 0;
                                i < this._routesRegexp.length && null === (r = this._routesRegexp[i].regex.exec(e));
                                i++
                            ) 
                            ;
                            if (null === r) 
        ...
        var de,
            ...
            Ae = function (e, t, i, r) {
                ...
                for (
                    ...
                    !1 !== t.reduceWhiteSpace && (n = n.replace(pe, " ").replace(_e, "")),
                    c && (n = n.split("<").join("{{LT}}")),
                    a = n.length,
                    o = (
                        " " === n.charAt(0)
            ...
            (i = [
                {
                    ...
                    value: function (e) {
                        ...
                        for (
                            var i = 0;
                            i < this.$heroDescription.querySelectorAll(".word").length;
                            i++
                        ) 
                            S
                                .a
                    ...
                    value: function () {
                        ...
                        for (
                            var n = 0;
                            n < this.$heroDescription.querySelectorAll(".word").length;
                            n++
                        ) 
                            this
                                .enterGalleryAnimation
                    ...
                    value: function () {
                        ...
                        this.superDragger = new We({
                            ...
                            onDragStart: function () {
                                ...
                                for (
                                    var t = 0;
                                    t < e.$discover.querySelectorAll(".slider__inner__item").length;
                                    t++
                                ) 
                                    S
                                        .a
                    ...
                    value: function (e) {
                        ...
                        switch (this.observerItems[e].id) {
                            ...
                            case "titleLarge":
                                ...
                                for (
                                    var r = 0;
                                    r < this.$discover.querySelector(".title--large").querySelectorAll(".word").length;
                                    r++
                                ) 
                                    S
                                        .a
                ...
                (i = [
                    {
                        ...
                        value: function () {
                            for (
                                var e = 0;
                                e < this.$heroDescription.querySelectorAll(".word").length;
                                e++
                            ) 
                                S
                                    .a
            ...
            (i = [
                {
                    ...
                    value: function (e) {
                        ...
                        for (
                            var i = 0;
                            i < this.$hero.querySelector(".title--small").querySelectorAll(".word").length;
                            i++
                        ) 
                            S
                                .a
                        ...
                        for (
                            var r = 0;
                            r < this.$hero.querySelector(".title--small").querySelectorAll(".word").length;
                            r++
                        ) 
                            this
                                .enterAnimation
                ...
                (i = [
                    {
                        ...
                        value: function (e) {
                            ...
                            for (
                                var t = 0;
                                t < this.$hero.querySelector(".title--small").querySelectorAll(".word").length;
                                t++
                            ) 
                                S
                                    .a
                        ...
                        value: function (e) {
                            ...
                            switch (this.observerItems[e].id) {
                                ...
                                case "titleExtraLarge":
                                    ...
                                    for (
                                        var r = 0;
                                        r < this.$footer.querySelector(".title--xlarge").querySelectorAll(".word").length;
                                        r++
                                    ) 
                                        S
                                            .a
            ...
            (i = [
                {
                    ...
                    value: function () {
                        ...
                        if (
                                ...
                                onRaf: function (t) {
                                    ...
                                    i < -window.innerHeight && i < t.position.y
                                        ...
                                        : e
                                            ...
                                            .menu
                                            .hideOpener(),
                                    !e.router.dragExplanation && i < -window.innerHeight + .06 * window.innerWidth && e.showExplanation()
                                }
                            }),
                            ...
                            for (
                                var t = 0;
                                t < this.$slider.querySelectorAll(".slider__inner__item").length;
                                t++
                            ) 
                                this
                                    .observerParallax
                    ...
                    value: function (e, t, i) {
                        ...
                        if (
                            e && e.preventDefault(),
                            this.isOpened = !0,
                            !this.superDragger || !this.superDragger._drag.dragging
                        ) {
                            this.archiveIndex = i,
                    ...
                    key: "renderArchive",
                    value: function (e, t) {
                        this.archiveComponent = new Nt(
                            {experience: e, destination: t, type: this.archiveType}
                        ),
                        this
                            .archiveComponent
                            .render(),
            ...
            (i = [
                {
                    ...
                    value: function (e) {
                        ...
                        for (
                            var i = 0;
                            i < this.$hero.querySelector(".title--xlarge").querySelectorAll(".word").length;
                            i++
                        ) 
                            S
                                .a
                        ...
                        for (
                            var r = 0;
                            r < this.$hero.querySelector(".title--xlarge").querySelectorAll(".word").length;
                            r++
                        ) 
                            this
                                .enterAnimation
                    ...
                    value: function () {
                        ...
                        for (
                            var t = 0;
                            t < this.$teamList.querySelectorAll(".slider__inner__item").length;
                            t++
                        ) 
                            this
                                .observerParallax
                    ...
                    value: function () {
                        ...
                        this.superDraggerTeam = new We({
                            ...
                            onDragStart: function () {
                                ...
                                for (
                                    var t = 0;
                                    t < e.$teamList.querySelectorAll(".slider__inner__item").length;
                                    t++
                                ) 
                                    S
                                        .a
                        ...
                        this
                            ...
                            .length > 3 && (
                                ...
                                onDragStart: function () {
                                    ...
                                    for (
                                        var t = 0;
                                        t < e.$teamAmbassadors.querySelectorAll(".slider__inner__item").length;
                                        t++
                                    ) 
                                        S
                                            .a
